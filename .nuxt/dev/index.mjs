...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getRouterParam, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, sendError, getResponseStatusText, H3Error } from 'file:///app/motoschool/node_modules/.pnpm/h3@1.15.1/node_modules/h3/dist/index.mjs';
...
import { klona } from 'file:///app/motoschool/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///app/motoschool/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///app/motoschool/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///app/motoschool/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { ErrorParser } from 'file:///app/motoschool/node_modules/.pnpm/youch-core@0.3.2/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///app/motoschool/node_modules/.pnpm/youch@4.1.0-beta.6/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///app/motoschool/node_modules/.pnpm/source-map@0.7.4/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///app/motoschool/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import devalue from 'file:///app/motoschool/node_modules/.pnpm/@nuxt+devalue@2.0.2/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { basename, isAbsolute } from 'file:///app/motoschool/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///app/motoschool/node_modules/.pnpm/@iconify+utils@2.3.0/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///app/motoschool/.nuxt/nuxt-icon-server-bundle.mjs';
import localAdapter from 'file:///app/motoschool/node_modules/.pnpm/db0@0.3.1_better-sqlite3@11.9.1/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///app/motoschool/node_modules/.pnpm/ipx@2.1.0_db0@0.3.1_better-sqlite3@11.9.1__ioredis@5.6.0/node_modules/ipx/dist/index.mjs';
import lruCacheDriver from 'file:///app/motoschool/node_modules/.pnpm/unstorage@1.15.0_db0@0.3.1_better-sqlite3@11.9.1__ioredis@5.6.0/node_modules/unstorage/drivers/lru-cache.mjs';
import { createGenerator } from 'file:///app/motoschool/node_modules/.pnpm/@unocss+core@66.0.0/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///app/motoschool/node_modules/.pnpm/@unocss+preset-wind3@66.0.0/node_modules/@unocss/preset-wind3/dist/index.mjs';
import { createUnhead } from 'file:///app/motoschool/node_modules/.pnpm/unhead@2.0.2/node_modules/unhead/dist/index.mjs';
import { Resvg } from 'file:///app/motoschool/node_modules/.pnpm/@resvg+resvg-js@2.6.2/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///app/motoschool/node_modules/.pnpm/satori@0.12.2/node_modules/satori/dist/index.js';

const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/app/motoschool/.nuxt/cache/nuxt-og-image@5.1.1/_fonts"},{"baseName":"server","dir":"/app/motoschool/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/app/motoschool","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/app/motoschool/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/app/motoschool/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/app/motoschool/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/app/motoschool/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/posts/sql_dump": {
        "prerender": true
      },
      "/__nuxt_content/index/sql_dump": {
        "prerender": true
      },
      "/__nuxt_content/pricing/sql_dump": {
        "prerender": true
      },
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/app/motoschool/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-site-config": {
  ...
  "nuxt-og-image": {
    ...
    "debug": true,
    "baseCacheKey": "/cache/nuxt-og-image/5.1.1",
    "fonts": [
      {
...
const _vq7gYs3uhgWYBWq_kdUJoBNW0syzY9pBui6xUF2ae88 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/app/motoschool";
...
const _a0MDr3Dv9ijwdzK7sghQ4RJ6YYkCfaCKwUo1UZYA5E = (nitroApp) => {
...
const _EblmV5L_G8jc2qXPJIATWhd6O_aqWs8m57zcOpLDAk = defineNitroPlugin(async (nitroApp) => {
...
const componentNames = [{"hash":"H0Jn3BvSYCbDA2RLwcOCp7-V0IZ9E1xRAD96wVKK1DA","pascalName":"OgImageSaas","kebabName":"og-image-saas","path":"/app/motoschool/app/components/OgImage/OgImageSaas.vue","category":"app"},{"hash":"MlnXt-4pSsc-S0S-NyO1mjaxwp9hRjHjCY9kvDedhdQ","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"fpeX9mEOdoiwmgFVE7hebxqWjsIhD1kTbNd-q3hCd44","pascalName":"Frame","kebabName":"frame","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"iEMfMtE3Z-GRD7M8UdLMA8z5kz-STiQ6hixM09D2-dU","pascalName":"Nuxt","kebabName":"nuxt","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"OPSMK5e1Mj-B-KLuoxjOG3CTzYq1s5ld-uvugb--Fog","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"9zhUtkB6optlrF0l5DEhgmR2EaIfGQP-Opy1PHC-ea0","pascalName":"Pergel","kebabName":"pergel","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"elBNvk6E8lXN8E9YywMD9ZKEiLvF8lfcfuj7SBFp5UI","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"NZaFkzgYlwbuyTVFd6EHH-xQWdLAvf9XnrhiwGpu4Sg","pascalName":"UnJs","kebabName":"un-js","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"QXHbDpwVYCs3sUZl2lD4T9ynY6wsyAvK7oqRs1B0wsI","pascalName":"Wave","kebabName":"wave","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"6osD1f2PCUicjON4dfrsnxhXzikrQ0yfi43nndOjEuY","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/app/motoschool/node_modules/.pnpm/nuxt-og-image@5.1.1_@unhead+vue@2.0.2_vue@3.5.13_typescript@5.8.2___magicast@0.3.5_unst_966ae88fa53b8b2d26b727dc806e567e/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
...
const _donYW5fKrRzLpQbJ2ipkiRbyJvcRJOxT3zMgBNoREIk = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _D3EsQHAfVKRGKPoz_y0snjmp9k6nEzJZV3pI8QbQ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _vq7gYs3uhgWYBWq_kdUJoBNW0syzY9pBui6xUF2ae88,
_a0MDr3Dv9ijwdzK7sghQ4RJ6YYkCfaCKwUo1UZYA5E,
_EblmV5L_G8jc2qXPJIATWhd6O_aqWs8m57zcOpLDAk,
_donYW5fKrRzLpQbJ2ipkiRbyJvcRJOxT3zMgBNoREIk,
_D3EsQHAfVKRGKPoz_y0snjmp9k6nEzJZV3pI8QbQ
];

const warnOnceSet = /* @__PURE__ */ new Set();
const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _jy6SKh = defineCachedEventHandler(async (event) => {
...
const _jz0VRe = defineEventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _b2pCDW = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _HkAoQI = eventHandler(async (event) => {
  ...
  return await import('file:///app/motoschool/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _SE91os = eventHandler(async (event) => {
...
const _XFJBlV = lazyEventHandler(() => {
...
const _lazy_MlSrhC = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_qw2Ngs = () => Promise.resolve().then(function () { return font$1; });
const _lazy_09iiKW = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_JSZvti = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_MlSrhC, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _jy6SKh, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_qw2Ngs, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _jz0VRe, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _b2pCDW, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_09iiKW, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_JSZvti, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_JSZvti, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _HkAoQI, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _SE91os, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _XFJBlV, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_MlSrhC, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_MlSrhC, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///app/motoschool/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///app/motoschool/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
